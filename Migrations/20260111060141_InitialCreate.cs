    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Show ca nhạc acoustic cực chill", new DateTime(2026, 1, 26, 13, 1, 41, 578, DateTimeKind.Local).AddTicks(9220), "/images/events/event1.jpg", "Sân khấu ngoài trời", "Đêm Nhạc Dưới Trăng", 100 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Sự kiện âm nhạc", null, new DateTime(2026, 1, 11, 13, 1, 41, 578, DateTimeKind.Local).AddTicks(9260), "/images/news/news1.png", "Music Concert Night" },
                    { 2, "Tin tức", null, new DateTime(2026, 1, 11, 13, 1, 41, 578, DateTimeKind.Local).AddTicks(9270), "/images/news/news2.jpg", "New Villa Opening" }
                });

            migrationBuilder.InsertData(
                table: "Rooms",
                columns: new[] { "Id", "Capacity", "Description", "HasBreakfast", "HasPool", "HasTowel", "HasWifi", "ImageUrl", "IsActive", "PricePerNight", "RatingStars", "RoomNumber", "SquareFootage", "Type" },
                values: new object[,]
                {
                    { 1, 10, "Villa view rừng cực đẹp", true, true, true, true, null, true, 5000000m, 5, "V01", 150.0, "Villa" },
                    { 2, 2, "Không gian lãng mạn", true, true, true, true, null, true, 1500000m, 4, "B01", null, "Bungalow" }
                });
