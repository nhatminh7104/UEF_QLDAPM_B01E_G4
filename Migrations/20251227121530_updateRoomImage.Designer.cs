...
namespace VillaManagementWeb.Migrations
{
    ...
    [Migration("20251227121530_updateRoomImage")]
            ...
            modelBuilder.Entity("VillaManagementWeb.Models.Booking", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AdultsCount = 2,
                            CheckIn = new DateTime(2025, 12, 29, 19, 15, 29, 968, DateTimeKind.Local).AddTicks(2739),
                            CheckOut = new DateTime(2026, 1, 1, 19, 15, 29, 968, DateTimeKind.Local).AddTicks(2747),
                            ChildrenCount = 1,
                            CreatedAt = new DateTime(2025, 12, 27, 19, 15, 29, 968, DateTimeKind.Local).AddTicks(2725),
            ...
            modelBuilder.Entity("VillaManagementWeb.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EventDate = new DateTime(2026, 1, 11, 19, 15, 29, 968, DateTimeKind.Local).AddTicks(2765),
            ...
            modelBuilder.Entity("VillaManagementWeb.Models.Ticket", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BookingDate = new DateTime(2025, 12, 27, 19, 15, 29, 968, DateTimeKind.Local).AddTicks(2819),
            ...
            modelBuilder.Entity("VillaManagementWeb.Models.TourBooking", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Status = "Pending",
                            TotalPrice = 2000000m,
                            TourDate = new DateTime(2026, 1, 6, 19, 15, 29, 968, DateTimeKind.Local).AddTicks(2857),
                            TourId = 1
                        });
                });
